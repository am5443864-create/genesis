  ...
  <section class="ubicanos-wrap" id="ubicanos">
    <div class="ubicanos-inner">
      ...
      <div class="contacto-box">
        <img class="contacto-bg" src="CONTACTO_COMPLETO.png" alt="Fondo contacto">
        ...
        <img class="genesis-cloud" src="nube_sola.png" alt="Nube">
        <img class="genesis-logo" src="logo_genesis.png" alt="Logo Genesis">
      </div>
